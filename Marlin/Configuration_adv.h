...
#define CONTROLLERFAN_PIN -1 //FAN2_PIN //Pin used for the fan to cool controller (-1 to disable)
...
// Define a pin to turn case light on/off
  ...
  #define CASE_LIGHT_PIN 37
#else
  #define CASE_LIGHT_PIN 59
#endif
...
#if defined(ARDUINO_ARCH_SAM)
  #define DELTA_FAST_SQRT // In case of AVR, this option is slower than default sqrt()
#endif
