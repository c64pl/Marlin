 ...
 *       RADDS_DISPLAY => REPRAP_DISCOUNT_SMART_CONTROLLER // This line is different from official RCBugFix: search tag: DIFFER_FROM_OFFICIAL
 *       SAV_3DGLCD => U8GLIB_SH1106 => ULTIMAKERCONTROLLER
 *       AZSMZ_12864_LCD => VIKI2 => ULTIMAKERCONTROLLER   // This line is different from official RCBugFix: search tag: DIFFER_FROM_OFFICIAL
 *       miniVIKI => ULTIMAKERCONTROLLER
 *       VIKI2 => ULTIMAKERCONTROLLER
 *       ELB_FULL_GRAPHIC_CONTROLLER => ULTIMAKERCONTROLLER
 *       PANEL_ONE => ULTIMAKERCONTROLLER
 *       SSD1306_OLED_I2C_CONTROLLER => U8GLIB_SSD1306     // This line is different from official RCBugFix: search tag: DIFFER_FROM_OFFICIAL
 */
#define COUNT_LCD_1 0
  ...
  #else
    #define COUNT_LCD_25 COUNT_LCD_24
  #endif
  #if ENABLED(SPARK_FULL_GRAPHICS)
    #define COUNT_LCD_26 INCREMENT(COUNT_LCD_25)
  #else
    #define COUNT_LCD_26 COUNT_LCD_25
  #endif
  #if ENABLED(AZSMZ_12864_LCD)
    #define COUNT_LCD_27 INCREMENT(COUNT_LCD_26)
  #else
    #define COUNT_LCD_27 COUNT_LCD_26
  #endif
  #if ENABLED(SSD1306_OLED_I2C_CONTROLLER)
    #define COUNT_LCD_28 INCREMENT(COUNT_LCD_27)
  #else
    #define COUNT_LCD_28 COUNT_LCD_27
  #endif
  #if COUNT_LCD_28 > 1
