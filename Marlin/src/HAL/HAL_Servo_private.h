...
#ifndef HAL_SERVO_PRIVATE_H
#define HAL_SERVO_PRIVATE_H

#include <inttypes.h>

// Architecture specific include
#if defined(ARDUINO_ARCH_SAM)
  #include "HAL_DUE/HAL_ServoTimers_Due.h"
/*
#elif defined(ARDUINO_ARCH_AVR)
  #include "HAL_AVR/HAL_ServoTimers_AVR.h"
*/
#else
  //#error "This library only supports boards with an AVR or SAM3X processor."
  #error "This library only supports boards with an SAM3X processor."
#endif
...
// Global variables
extern ServoInfo_t servo_info[MAX_SERVOS];    // static array of servo structures
extern uint8_t ServoCount;        // the total number of attached servos

// Public functions
extern void initISR(timer16_Sequence_t timer);
extern void finISR(timer16_Sequence_t timer);

#endif // HAL_SERVO_PRIVATE_H
